...
namespace GravityWebExt.Models
{
    ...
    public class RecomValWebData
    {
        ...
        public double DevArrMasMa1 { get; set; }
        public double DevArrMasMa2 { get; set; }
        public double DevArrMasMa3 { get; set; }
        public double DevArrMasMa4 { get; set; }
        public double DevArrMasMa5 { get; set; }
        public double DevArrMasMa6 { get; set; }
        ...
        public double DevArrMasMm1 { get; set; }
        public double DevArrMasMm2 { get; set; }
        public double DevArrMasMm3 { get; set; }
        public double DevArrMasMm4 { get; set; }
        public double DevArrMasMm5 { get; set; }
        public double DevArrMasMm6 { get; set; }
